...
{
    [Activity(Label = "AlarmActivity", WindowSoftInputMode = SoftInput.AdjustResize)]
    public class AlarmActivity : AppCompatActivity
    {
        ...
        protected override async void OnCreate(Bundle savedInstanceState)
        {
            ...
            if (loggedUser.Email != "failed")
            {
                ...
                var hubConnection = new HubConnection("http://192.168.1.18/PwszAlarmApi");
        ...
        {
            string textToShow;
            if (item.ItemId == Resource.Id.menu_evacuation_route) textToShow = "Learn more";
            else
                textToShow = "Overflow";
            Android.Widget.Toast.MakeText(this, item.TitleFormatted + ": " + textToShow, Android.Widget.ToastLength.Long).Show();
